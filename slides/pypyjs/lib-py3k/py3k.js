//
//  Py3KJS:  an experimental in-browser python3 environment.
//

(function() {

// Expose the main Py3KJS function at global scope for this file,
// as well as in any module exports or 'window' object we can find.
if (this) {
  this.Py3KJS = Py3KJS;
}
if (typeof window !== "undefined") {
  window.Py3KJS = Py3KJS;
}
if (typeof module !== "undefined") {
  if (typeof module.exports !== "undefined") {
    module.exports = Py3KJS;
  }
}
...
if (typeof __dirname === "undefined") {
  ...
  for (var i = 0; i < errlines.length; i++) {
    var match = /(at |@)(.+\/)py3k.js/.exec(errlines[i]);
    if (match) {
      __dirname = match[2];
      break;
    }
...
function Py3KJS(opts) {
  ...
  if (!this.rootURL && !Py3KJS.rootURL) {
    Py3KJS.rootURL = __dirname;
  }
  ...
  this.ready = new Promise((function(resolve, reject) {
    ...
    .then((function(xhr) {
      ...
      Module.thisProgram = "/lib/pypyjs/py3k.js";
      Module.filePackagePrefixURL = this.rootURL || Py3KJS.rootURL;
      Module.memoryInitializerPrefixURL = this.rootURL || Py3KJS.rootURL;
      Module.locateFile = function(name) {
        return (this.rootURL || Py3KJS.rootURL) + name;
      }
      ...
      return initializedP.then((function() {
        ...
        return moduleDataP.then((function(xhr) {
          ...
          // It's now safe to start the VM.
          Module._rpython_startup_code();
          var pypy_home = Module.intArrayFromString("/lib/pypyjs/py3k.js");
          pypy_home = Module.allocate(pypy_home, 'i8', Module.ALLOC_NORMAL);
          Module._pypy_setup_home(pypy_home, 0);
          Module._free(pypy_home);
          // Fix stdout weirdness.
          var code = Module.intArrayFromString("import sys, io; sys.stdout = io.open(1, 'w', encoding='ascii', buffering=1, closefd=False);");
...
// that treats paths as relative to the py3k.js root url.
//
Py3KJS.prototype.fetch = function fetch(relpath, responseType) {
  ...
  if (typeof XMLHttpRequest !== "undefined") {
    return new Promise((function(resolve, reject) {
      ...
      var rootURL = this.rootURL || Py3KJS.rootURL;
...
//
Py3KJS.prototype.eval = function eval(code) {
...
Py3KJS._resultsID = 0;
Py3KJS._resultsMap = {};
Py3KJS.prototype.get = function get(name) {
  return this.ready.then((function() {
    var Module = this._module;
    var resid = ""+(Py3KJS._resultsID++);
    return new Promise((function(resolve, reject) {
      name = name.replace(/\\/g, "\\\\").replace(/'/g, "\\'");
      var code = "globals()['" + name + "']";
      code = "js.convert(" + code + ")"
      code = "js.globals['Py3KJS']._resultsMap['" + resid + "'] = " + code;
      var code_chars = Module.intArrayFromString(code);
      var code_ptr = Module.allocate(code_chars, 'i8', Module.ALLOC_NORMAL);
      if (!code_ptr) {
      ...
      if (res !== 0) {
        ...
        resolve(Py3KJS._resultsMap[resid]);
        delete Py3KJS._resultsMap[resid];
      }
    }).bind(this));
  }).bind(this));
}
...
//
Py3KJS.prototype.set = function set(name, value) {
  return this.ready.then((function() {
    var Module = this._module;
    return new Promise((function(resolve, reject) {
...
Py3KJS.prototype.findImportedNames = function findImportedNames(code) {
  var match = null;
  var imports = [];
...
//
Py3KJS.prototype.loadModuleData = function loadModuleData(/* names */) {
...
Py3KJS.prototype._findModuleDeps = function _findModuleDeps(name, seen) {
  if (!seen) seen = {};
  var deps = [];
...
Py3KJS.prototype._makeLoadModuleData = function _makeLoadModuleData(name) {
  return (function() {
...
Py3KJS.prototype._writeModuleFile = function _writeModuleFile(name, data) {
  var Module = this._module;
